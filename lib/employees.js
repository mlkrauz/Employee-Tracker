...
function employees() {
     ...
     */
    employeeNameExists = async (employeeName_first, employeeName_last) => {
     ...
     */
    employeeIdExists = async (employeeId) => {
    ...
    return {
         ...
         */
        employeesByDepartment: async (deptId) => {
         ...
         */
        employeesByManager: async (managerId) => {
         ...
         */
        addEmployee: async (employeeName_first, employeeName_last, roleId, managerId) => {
         ...
         */
        changeEmployeeRole: async (employeeId, newRoleId) => {
         ...
         */
        changeEmployeeManager: async (employeeId, newManagerId) => {
            employeeIdExists(employeeId)
         ...
         */
        getIDbyName: async (employeeName_first, employeeName_last) => {
